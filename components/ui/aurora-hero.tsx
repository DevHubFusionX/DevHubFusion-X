...
export function AuroraHero({
  ...
  const filterImageHref = "data:image/svg+xml," + encodeURIComponent(`
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1 1' color-interpolation-filters='sRGB'>
      <g>
        ...
        <rect width='1' height='1' fill='url(#emerald)' style='mix-blend-mode:screen' />
        <rect width='1' height='1' fill='url(#teal)' style='mix-blend-mode:screen' />
        <rect width='1' height='1' fill='url(#green)' style='mix-blend-mode:screen' />
      </g>
      <defs>
        <radialGradient id='green' cx='0' cy='0' r='1' >
          <stop stop-color='#059669' />
          <stop stop-color='#059669' offset='1' stop-opacity='0' />
        </radialGradient>
        <radialGradient id='teal' cx='1' cy='0' r='1' >
          <stop stop-color='#5eead4' />
          <stop stop-color='#5eead4' offset='1' stop-opacity='0' />
        </radialGradient>
        <radialGradient id='emerald' cx='0' cy='1' r='1' >
          <stop stop-color='#34d399' />
          <stop stop-color='#34d399' offset='1' stop-opacity='0' />
        </radialGradient>
      </defs>
    </svg>
  `);
  ...
  return (
    <div
      className={cn("aurora-hero-wrapper w-full h-full relative overflow-hidden", className)}
      {...props}
    >
      <style>{`
        .aurora-hero-wrapper {
      ...
      {/* Only render the content overlay when there's something to show */}
      {(children || title) && (
